...
(global-set-key (kbd "C-x /") 'rotate-windows) ;; also 'my-rotate-windows
...
(global-set-key (kbd "C-x O") (ffip-create-pattern-file-finder "*.*"))
(global-set-key (kbd "C-x t") (ffip-create-pattern-file-finder "*.*"))
