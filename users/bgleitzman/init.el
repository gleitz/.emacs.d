...
(fset 'unspace
      [?\M-r ?\C-q ?\C-j ?\C-q ?\C-j ?+ return ?\[ ?b ?a ?c ?k ?s ?p ?a ?c ?e ?\] backspace backspace backspace backspace backspace backspace backspace backspace backspace backspace ?d ?o ?u ?b ?l ?e ?s ?p ?a ?e backspace backspace ?a ?c ?e ?\] return ?\M-r ?\C-q ?\C-j return ?  return ?\M-r ?\\ ?\[ ?d ?o ?u ?b ?l ?e ?s ?p ?a ?c ?e ?\' ?\] left backspace ?\\ ?\C-e return ?\C-q ?\C-j ?\C-q ?\C-j return ?\C-x])
